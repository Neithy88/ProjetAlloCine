...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 03 déc. 2018 à 08:29
...
INSERT INTO `films` (`id_films`, `titre`, `annee`, `description`, `image`) VALUES
...
(2, 'Forrest Gump', 1994, '\"Quelques decennies d\'histoire americaine, des annees 1940 à la fin du XX eme siecle, à travers le regard et l\'étrange odyssée d\'un homme simple et pur, Forrest Gump.\"', 'forrestgump.png'),
...
(17, 'A la rencontre de Forrester', 2001, '\"A seize ans, Jamal Wallace, un prodige du basket-ball, entre par effraction dans un appartement que les rumeurs disent habité par un ermite. Ayant entendu un bruit, il prend ses jambes à son cou et en oublie son sac à dos avec ses livres dedans. L\'ermite le lui rend. Jamal constate que les textes qu\'il a écrits ont été corrigés et commentés.\"', 'alarencontredeforrester.png'),
(18, 'Dikkenek', 2006, 'JC et Stef sont des amis d\'enfance. Inséparables. JC est le dikkenek belge, un donneur de leçon à cinq balles, un moralisateur, un tombeur de minettes, bref une grande gueule intégrale, coiffé comme un peigne. Stef est tout le contraire. Il cherche le Grand Amour, mais vu qu\'il ne bouge pas de son lit, il va avoir du mal à trouver. JC lui explique donc la méthode : faire un sans-faute du point A jusqu\'au point G.', 'dikkenek.png');
